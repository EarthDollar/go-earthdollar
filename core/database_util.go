...
func GetHeaderRLP(db eddb.Database, hash common.Hash) rlp.RawValue {
...
// found.
func GetHeader(db eddb.Database, hash common.Hash) *types.Header {
...
func GetBodyRLP(db eddb.Database, hash common.Hash) rlp.RawValue {
...
func GetBody(db eddb.Database, hash common.Hash) *types.Body {
...
// none found.
func GetTd(db eddb.Database, hash common.Hash) *big.Int {
...
func GetBlock(db eddb.Database, hash common.Hash) *types.Block {
...
func GetBlockReceipts(db eddb.Database, hash common.Hash) types.Receipts {
...
func WriteBody(db eddb.Database, hash common.Hash, body *types.Body) error {
...
func WriteTd(db eddb.Database, hash common.Hash, td *big.Int) error {
...
func WriteBlockReceipts(db eddb.Database, hash common.Hash, receipts types.Receipts) error {
...
func DeleteBlockReceipts(db eddb.Database, hash common.Hash) {
