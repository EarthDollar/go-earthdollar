...
func GetCanonicalHash(db eddb.Database, number uint64) common.Hash {
...
func GetBlockNumber(db eddb.Database, hash common.Hash) uint64 {
...
func GetHeadHeaderHash(db eddb.Database) common.Hash {
...
func GetHeadBlockHash(db eddb.Database) common.Hash {
...
func GetHeadFastBlockHash(db eddb.Database) common.Hash {
...
func GetHeaderRLP(db eddb.Database, hash common.Hash, number uint64) rlp.RawValue {
...
// found.
func GetHeader(db eddb.Database, hash common.Hash, number uint64) *types.Header {
...
func GetBodyRLP(db eddb.Database, hash common.Hash, number uint64) rlp.RawValue {
...
func GetBody(db eddb.Database, hash common.Hash, number uint64) *types.Body {
...
// none found.
func GetTd(db eddb.Database, hash common.Hash, number uint64) *big.Int {
...
func GetBlock(db eddb.Database, hash common.Hash, number uint64) *types.Block {
...
func GetBlockReceipts(db eddb.Database, hash common.Hash, number uint64) types.Receipts {
...
func GetTransaction(db eddb.Database, hash common.Hash) (*types.Transaction, common.Hash, uint64, uint64) {
...
func GetReceipt(db eddb.Database, txHash common.Hash) *types.Receipt {
...
func WriteHeadHeaderHash(db eddb.Database, hash common.Hash) error {
...
func WriteHeadBlockHash(db eddb.Database, hash common.Hash) error {
...
func WriteHeadFastBlockHash(db eddb.Database, hash common.Hash) error {
...
func WriteHeader(db eddb.Database, header *types.Header) error {
...
func WriteBody(db eddb.Database, hash common.Hash, number uint64, body *types.Body) error {
...
func WriteBodyRLP(db eddb.Database, hash common.Hash, number uint64, rlp rlp.RawValue) error {
...
func WriteTd(db eddb.Database, hash common.Hash, number uint64, td *big.Int) error {
...
func WriteBlock(db eddb.Database, block *types.Block) error {
...
func WriteBlockReceipts(db eddb.Database, hash common.Hash, number uint64, receipts types.Receipts) error {
...
func WriteTransactions(db eddb.Database, block *types.Block) error {
	batch := db.NewBatch()
...
func WriteReceipt(db eddb.Database, receipt *types.Receipt) error {
...
func WriteReceipts(db eddb.Database, receipts types.Receipts) error {
	batch := db.NewBatch()
...
func DeleteCanonicalHash(db eddb.Database, number uint64) {
	db.Delete(append(append(headerPrefix, encodeBlockNumber(number)...), numSuffix...))
}

// DeleteHeader removes all block header data associated with a hash.
func DeleteHeader(db eddb.Database, hash common.Hash, number uint64) {
	db.Delete(append(blockHashPrefix, hash.Bytes()...))
	db.Delete(append(append(headerPrefix, encodeBlockNumber(number)...), hash.Bytes()...))
}

// DeleteBody removes all block body data associated with a hash.
func DeleteBody(db eddb.Database, hash common.Hash, number uint64) {
	db.Delete(append(append(bodyPrefix, encodeBlockNumber(number)...), hash.Bytes()...))
}

// DeleteTd removes all block total difficulty data associated with a hash.
func DeleteTd(db eddb.Database, hash common.Hash, number uint64) {
	db.Delete(append(append(append(headerPrefix, encodeBlockNumber(number)...), hash.Bytes()...), tdSuffix...))
}

// DeleteBlock removes all block data associated with a hash.
func DeleteBlock(db eddb.Database, hash common.Hash, number uint64) {
...
func DeleteBlockReceipts(db eddb.Database, hash common.Hash, number uint64) {
	db.Delete(append(append(blockReceiptsPrefix, encodeBlockNumber(number)...), hash.Bytes()...))
}

// DeleteTransaction removes all transaction data associated with a hash.
func DeleteTransaction(db eddb.Database, hash common.Hash) {
...
func DeleteReceipt(db eddb.Database, hash common.Hash) {
...
func GetBlockByHashOld(db eddb.Database, hash common.Hash) *types.Block {
...
// MIP bloom bin.
func WriteMipmapBloom(db eddb.Database, number uint64, receipts types.Receipts) error {
	mipmapBloomMu.Lock()
...
func GetMipmapBloom(db eddb.Database, number, level uint64) types.Bloom {
	bloomDat, _ := db.Get(mipmapKey(number, level))
	return types.BytesToBloom(bloomDat)
}

// PreimageTable returns a Database instance with the key prefix for preimage entries.
func PreimageTable(db eddb.Database) eddb.Database {
	return eddb.NewTable(db, preimagePrefix)
}

// WritePreimages writes the provided set of preimages to the database. `number` is the
// current block number, and is used for debug messages only.
func WritePreimages(db eddb.Database, number uint64, preimages map[common.Hash][]byte) error {
...
func WriteBlockChainVersion(db eddb.Database, vsn int) {
	enc, _ := rlp.EncodeToBytes(uint(vsn))
	db.Put([]byte("BlockchainVersion"), enc)
}

// WriteChainConfig writes the chain config settings to the database.
func WriteChainConfig(db eddb.Database, hash common.Hash, cfg *params.ChainConfig) error {
...
func GetChainConfig(db eddb.Database, hash common.Hash) (*params.ChainConfig, error) {
...
func FindCommonAncestor(db eddb.Database, a, b *types.Header) *types.Header {
