...
import (
	...
	"github.com/Earthdollar/go-earthdollar/ed/fetcher"
...
func NewProtocolManager(fastSync bool, networkId int, mux *event.TypeMux, txpool txPool, pow pow.PoW, blockchain *core.BlockChain, chaindb eddb.Database) (*ProtocolManager, error) {
...
func (pm *ProtocolManager) Stop() {
	...
	glog.V(logger.Info).Infoln("Earthdollae protocol handler stopped")
}
...
func (pm *ProtocolManager) handleMsg(p *peer) error {
	...
	case p.version < ed62 && msg.Code == GetBlockHashesMsg:
	...
	case p.version < ed62 && msg.Code == GetBlockHashesFromNumberMsg:
	...
	case p.version < ed62 && msg.Code == BlockHashesMsg:
	...
	case p.version < ed62 && msg.Code == GetBlocksMsg:
	...
	case p.version < ed62 && msg.Code == BlocksMsg:
