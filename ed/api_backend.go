...
// EthApiBackend implements edapi.Backend for full nodes
...
func (b *EthApiBackend) StateAndHeaderByNumber(ctx context.Context, blockNr rpc.BlockNumber) (edapi.State, *types.Header, error) {
...
func (b *EthApiBackend) GetVMEnv(ctx context.Context, msg core.Message, state edapi.State, header *types.Header) (*vm.EVM, func() error, error) {
...
func (b *EthApiBackend) ChainDb() eddb.Database {
