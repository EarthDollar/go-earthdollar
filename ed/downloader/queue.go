...
type fetchRequest struct {
	...
	Hashes  map[common.Hash]int // [ed/61] Requested hashes with their insertion index (priority)
...
type queue struct {
	...
	hashPool    map[common.Hash]int // [ed/61] Pending hashes, mapping to their insertion index (priority)
	hashQueue   *prque.Prque        // [ed/61] Priority queue of the block hashes to fetch
	hashCounter int                 // [ed/61] Counter indexing the added hashes to ensure retrieval order
