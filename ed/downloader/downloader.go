...
import (
	...
	ethereum "github.com/EarthDollar/go-earthdollar"
...
func New(mode SyncMode, stateDb eddb.Database, mux *event.TypeMux, hasHeader headerCheckFn, hasBlockAndState blockAndStateCheckFn,
