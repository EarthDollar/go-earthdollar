...
import (
	...
	"github.com/EarthDollar/go-earthdollar"
...
type ContractBackend struct {
	eapi  *edapi.PublicEthereumAPI        // Wrapper around the Ethereum object to access metadata
	bcapi *edapi.PublicBlockChainAPI      // Wrapper around the blockchain to access chain data
	txapi *edapi.PublicTransactionPoolAPI // Wrapper around the transaction pool to access transaction data
}

// NewContractBackend creates a new native contract backend using an existing
// Etheruem object.
func NewContractBackend(apiBackend edapi.Backend) *ContractBackend {
	return &ContractBackend{
		eapi:  edapi.NewPublicEthereumAPI(apiBackend),
		bcapi: edapi.NewPublicBlockChainAPI(apiBackend),
		txapi: edapi.NewPublicTransactionPoolAPI(apiBackend),
	}
}
...
func toCallArgs(msg ethereum.CallMsg) edapi.CallArgs {
	args := edapi.CallArgs{
		To:   msg.To,
		From: msg.From,
		Data: msg.Data,
