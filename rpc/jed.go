...
type Jed struct {
	edApi shared.EarthdollarApi
	re     *jsre.JSRE
	client comms.EarthdollarClient
	fe     xed.Frontend
}

func NewJed(edApi shared.EarthdollarApi, re *jsre.JSRE, client comms.EarthdollarClient, fe xed.Frontend) *Jed {
	return &Jed{edApi, re, client, fe}
}

func (self *Jed) err(call otto.FunctionCall, code int, msg string, id interface{}) (response otto.Value) {
...
func (self *Jed) Send(call otto.FunctionCall) (response otto.Value) {
...
func (self *Jed) handleRequest(req *shared.Request) bool {
	var err error
	var args []interface{}
...
func (self *Jed) askPassword(id interface{}, jsonrpc string, args []interface{}) bool {
	var err error
	var passwd string
	if len(args) >= 1 {
...
func (self *Jed) confirmTransaction(id interface{}, jsonrpc string, args []interface{}) bool {
