 ...
 * @param {String} type
 * @returns {Number} length of dynamic type, 0 or multiplication of ED_PADDING (32)
 */
var dynamicBytesLength = function (type) {
    if (isArrayType(type) || type === 'bytes')
        return c.ED_PADDING * 2;
    return 0;
};
...
var formatInputString = function (value) {
    return utils.fromAscii(value, c.ED_PADDING).substr(2);
};
...
module.exports = {
    ...
    ED_POLLING_TIMEOUT: 1000,
    ED_DEFAULTBLOCK: 'latest'
};
