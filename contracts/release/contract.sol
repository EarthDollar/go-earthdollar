...
// versions of the go-ethereum implementation. Its goal is to allow Ged to
// check for new releases automatically without the need to consult a central
// repository.
//
// The contract takes a vote based approach on both assigning authorised signers
// as well as signing off on new Ged releases.
//
...
contract ReleaseOracle {
  ...
  // Version is the version details of a particular Ged release
  struct Version {
