...
// NodeConfig represents the collection of configuration values to fine tune the Ged
...
// Node represents a Ged Ethereum node instance.
type Node struct {
	node *node.Node
}

// NewNode creates and configures a new Ged node.
