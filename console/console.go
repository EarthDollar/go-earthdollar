...
import (
	...
	"github.com/EarthDollar/go-earthdollar/internal/web3ext"
...
// Welcome show summary of current Ged instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic Ged metadata
